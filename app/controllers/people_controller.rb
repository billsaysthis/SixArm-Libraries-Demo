class PeopleController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @person.save
        format.html { redirect_to(companies_path, :notice => 'Staffer was successfully created.') }
  ...
  def update
    ...
    respond_to do |format|
      if @person.update_attributes(params[:person])
        format.html { redirect_to(companies_path, :notice => 'Staffer was successfully updated.') }
        format.xml  { head :ok }
      else
